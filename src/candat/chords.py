...
CTRL_X_MAP: dict[str, tuple[str, str]] = {
    ...
    "2": ("split_window_below", "split window below"),
    "3": ("split_window_right", "split window right"),
    "0": ("delete_window", "delete window"),
    "1": ("delete_other_windows", "delete other windows"),
